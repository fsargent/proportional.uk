<script lang="ts">
	...
	function buildTimeline(opts: { repeat: number; repeatDelay: number; paused: boolean }) {
		...
		tl.set(q('.scene'), { autoAlpha: 0 })
			...
			.fromTo(q1('.scene-3 .bg-image'), { scale: 1.05, opacity: 0 }, { scale: 1, opacity: 0.2, duration: 0.4 })
...
<div class="video-frame" class:export-mode={mode === 'export'} bind:this={root}>
	...
	<div class="scene scene-1">
		...
		<div class="kicker">Make It Make Sense</div>
		<div class="headline headline-1">
			<div class="clip"><span class="glitch-line">28% OF</span></div>
			<div class="clip"><span class="glitch-line acid flash-word">VOTES</span></div>
			<div class="clip"><span class="glitch-line">60% OF MPS</span></div>
		</div>
		<div class="subhead">If an election was called today, Reform would get 28% of votes but 60% of MPs.</div>
	</div>
	...
	<div class="scene scene-2">
		...
		<div class="panel stat-panel">
			...
			<div class="stat-line">ONE RULE</div>
			<div class="stat-line dim">FOR THEM</div>
			<div class="stat-line acid">ANOTHER FOR US</div>
			<div class="microcopy">The maths are simple. Votes should decide seats. Nothing else.</div>
		</div>
	</div>
	...
	<div class="scene scene-3">
		...
		<div class="fix">FAIRER VOTES<br />= BETTER<br />REPRESENTATION</div>
		<div class="sub">Let's change the system.</div>
		<div class="grid">
	...
	<div class="scene scene-4">
		...
		<div class="cta-line">MAKE IT</div>
		<div class="cta-line acid">MAKE SENSE</div>
