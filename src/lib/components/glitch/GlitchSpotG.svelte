<script lang="ts">
	...
	function buildTimeline(opts: { repeat: number; repeatDelay: number; paused: boolean }) {
		...
		tl.set(q('.scene'), { autoAlpha: 0 })
			...
			.fromTo(q1('.scene-1 .bg-image'), { scale: 1.12, opacity: 0 }, { scale: 1, opacity: 0.35, duration: 0.6 })
			.fromTo(
			...
			.fromTo(q1('.scene-2 .bg-image'), { scale: 1.08, opacity: 0 }, { scale: 1, opacity: 0.25, duration: 0.4 })
...
<div class="video-frame" class:export-mode={mode === 'export'} bind:this={root}>
	...
	<div class="scene scene-1">
		...
		<div class="kicker">In 2019</div>
		<div class="headline headline-1">
			<div class="clip"><span class="glitch-line">22 MILLION</span></div>
			<div class="clip"><span class="glitch-line acid flash-word">VOTES</span></div>
			<div class="clip"><span class="glitch-line">DIDN'T COUNT</span></div>
		</div>
		<div class="subhead">Over 22 million votes (70%) went to losing candidates. Not one counted.</div>
	</div>

	<div class="scene scene-2">
		<img class="bg-image" src="/images/glitch/One_rule_for_them_1080.png" alt="" aria-hidden="true" />
		<div class="panel stat-panel">
			<div class="tiny-label">They Told You</div>
			<div class="stat-line">VOTING WAS</div>
			<div class="stat-line acid">ENOUGH</div>
			<div class="stat-line dim">THEY LIED</div>
			<div class="microcopy">If politics was fair, would the country be in the state it's in?</div>
		</div>
	</div>

	<div class="scene scene-3">
		<div class="tiny-label">Change The Game</div>
		<div class="fix">WE'RE NOT JUST<br />CHANGING THE<br />PLAYERS</div>
		<div class="sub">We're changing the game.</div>
		<div class="patch-note">The maths are simple. Votes should decide seats.</div>
		<div class="grid">
	...
	<div class="scene scene-4">
		...
		<div class="cta-line">POLITICS ISN'T</div>
		<div class="cta-line acid">WORKING</div>
		<a class="url" href="https://www.open-britain.co.uk/ncer" target="_blank" rel="noreferrer"
			>open-britain.co.uk/ncer</a
		>
		<div class="variant-tag">Let's take charge.</div>
	</div>
</div>
