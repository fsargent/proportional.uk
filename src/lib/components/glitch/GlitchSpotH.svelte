<script lang="ts">
	...
	function buildTimeline(opts: { repeat: number; repeatDelay: number; paused: boolean }) {
		...
		tl.set(q('.scene'), { autoAlpha: 0 })
			...
			.fromTo(q1('.scene-1 .bg-image'), { scale: 1.1, opacity: 0 }, { scale: 1, opacity: 0.4, duration: 0.65 })
			.fromTo(q('.scene-1 .headline-line'), { yPercent: 110, opacity: 0 }, { yPercent: 0, opacity: 1, stagger: 0.08, duration: 0.46 }, '-=0.3')
...
<div class="video-frame" class:export-mode={mode === 'export'} bind:this={root}>
	...
	<div class="scene scene-1">
		...
		<div class="headline">
			<div class="clip"><span class="headline-line">YOU WOULDN'T</span></div>
			<div class="clip"><span class="headline-line accent">ACCEPT 35%</span></div>
			<div class="clip"><span class="headline-line">OF YOUR WAGES</span></div>
		</div>
		<div class="subhead">Why accept it in your vote?</div>
	</div>
	...
	<div class="scene scene-4">
		...
		<div class="cta">LET'S MAKE IT</div>
		<div class="cta accent">WORK FOR US</div>
